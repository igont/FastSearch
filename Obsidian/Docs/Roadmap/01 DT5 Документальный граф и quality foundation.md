...
Этап заменён FastGraph FG4. [Передача графового контура](<../FastGraph.md>) объясняет новую последовательность. DT5 сохраняется как исторический паспорт и не является следующим этапом FastSearch.
