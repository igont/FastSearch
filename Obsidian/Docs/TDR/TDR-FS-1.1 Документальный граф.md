...
Решение передано FastGraph и заменено его TDR-FG-1.2 и этапом FG4. [Карта передачи](<../FastGraph.md>) содержит целевые ссылки. Файл сохраняется как история прежнего проектирования FastSearch.
