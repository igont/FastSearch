...
Решение передано FastGraph и заменено его TDR-FG-1.3 и этапом FG5. [Карта передачи](<../FastGraph.md>) содержит целевые ссылки. Файл сохраняется как история прежнего проектирования FastSearch.
