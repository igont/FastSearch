...
Решение передано FastGraph и заменено его TDR-FG-1.10, TDR-FG-1.4 и этапами FG5 и FG7. [Карта передачи](<../FastGraph.md>) содержит целевые ссылки. Файл сохраняется как история прежнего проектирования FastSearch.
