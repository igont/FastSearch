...
Решение передано FastGraph и заменено его TDR-FG-1.11, TDR-FG-1.4 и этапами FG6 и FG5. [Карта передачи](<../FastGraph.md>) содержит целевые ссылки. Файл сохраняется как история прежнего проектирования FastSearch.
