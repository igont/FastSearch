...
Графовая часть решения передана FastGraph и заменена его TDR-FG-1.7. Квалификация поисковых моделей остаётся в действующих TDR-FS-2.4, TDR-FS-2.5 и TDR-FS-2.6. [Карта передачи](<../FastGraph.md>) разделяет эти ответственности.
