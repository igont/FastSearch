...
Промежуточная команда выполнила `1/1` тест за 13,71 с. Последовательный прогон MCP выполнил `4/4` сценария за 187,31 с; тяжёлые тестовые сценарии при этом не выполнялись одновременно.
